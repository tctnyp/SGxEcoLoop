...
const submissions = new Map<string, unknown>([
  ['sub_devan', { id: 'sub_devan', userId: 'member_devan', task: 'Sort a shared recycling point', note: 'Separated cans, bottles, and clean paper at our block recycling corner.', photoDataUrl: evidence('Sorted recycling point', '#8bd3c1'), status: 'pending', points: null, aiConfidence: 0.72, aiLabel: 'bottle', aiAccepted: false, aiDetections: [{ label: 'bottle', confidence: 0.72 }, { label: 'cup', confidence: 0.46 }], aiProcessingMs: 91.4, aiSummary: 'YOLO detected 1 bottle and 1 cup.', aiDecisionReason: 'Matched bottle at 72.0%, below the 80% automatic threshold.', aiModel: 'yolo26n.pt', createdAt: iso(0, 8, 35), rewardApplied: false }],
  ['sub_amira', { id: 'sub_amira', userId: 'member_amira', task: 'Bring a reusable lunch kit', note: 'Used my own container and cutlery for lunch instead of disposables.', photoDataUrl: evidence('Reusable lunch kit', '#f4d06f'), status: 'approved', points: 50, aiConfidence: 0.94, aiLabel: 'cup', aiAccepted: true, aiDetections: [{ label: 'cup', confidence: 0.94 }, { label: 'bowl', confidence: 0.81 }], aiProcessingMs: 84.7, aiSummary: 'YOLO detected 1 cup and 1 bowl.', aiDecisionReason: 'Matched cup at 94.0%, above the 80% automatic threshold.', aiModel: 'yolo26n.pt', createdAt: iso(-1, 12, 20), rewardApplied: true }],
  ['sub_meilin', { id: 'sub_meilin', userId: 'member_meilin', task: 'Return drink containers', note: 'Returned eligible containers after our weekend picnic.', photoDataUrl: evidence('Container return', '#8ab6f9'), status: 'changes_requested', points: null, aiConfidence: 0.41, aiLabel: 'bottle', aiAccepted: false, aiDetections: [{ label: 'bottle', confidence: 0.41 }], aiProcessingMs: 88.2, aiSummary: 'YOLO detected 1 bottle.', aiDecisionReason: 'Matched bottle at 41.0%, below the 80% automatic threshold.', aiModel: 'yolo26n.pt', createdAt: iso(-2, 17, 10), rewardApplied: false }],
]);
